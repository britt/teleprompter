...
(() => {
    ...
    var Re = Object.getPrototypeOf, Me = Object.prototype.hasOwnProperty;
    var Fe = (t, e) => () => (e || t((e = { exports: {} }).exports, e), e.exports);
    var De = (t, e, n, r) => { if (e && typeof e == "object" || typeof e == "function")
        for (let i of _e(e))
            !Me.call(t, i) && i !== n && ie(t, i, { get: () => e[i], enumerable: !(r = Oe(e, i)) || r.enumerable }); return t; };
    var Ae = (t, e, n) => (n = t != null ? Pe(Re(t)) : {}, De(e || !t || !t.__esModule ? ie(n, "default", { value: t, enumerable: !0 }) : n, t));
    var ue = Fe((ae, le) => {
        (function () {
...
`, e);
            ...
            } return h = z, x = p, h.test(c) && x.test(c) && (h = w, c = c.replace(h, "")), T == "y" && (c = T.toLowerCase() + c.substr(1)), c; }; return function (R) { return R.update(H); }; }(), t.Pipeline.registerFunction(t.stemmer, "stemmer");
            ...
            t.TokenSet = function () { this.final = !1, this.edges = {}, this.id = t.TokenSet._nextId, t.TokenSet._nextId += 1; }, t.TokenSet._nextId = 1, t.TokenSet.fromArray = function (e) { for (var n = new t.TokenSet.Builder, r = 0, i = e.length; r < i; r++)
                ...
                if (s.editsRemaining != 0) {
                    ...
                    if (s.str.length > 1) {
                        var d = s.str.charAt(0), m = s.str.charAt(1), p;
                        m in s.node.edges ? p = s.node.edges[m] : (p = new t.TokenSet, s.node.edges[m] = p), s.str.length == 1 && (p.final = !0), i.push({ node: p, editsRemaining: s.editsRemaining - 1, str: d + s.str.slice(2) });
                    }
                }
            ...
            t.Index = function (e) { this.invertedIndex = e.invertedIndex, this.fieldVectors = e.fieldVectors, this.tokenSet = e.tokenSet, this.fields = e.fields, this.pipeline = e.pipeline; }, t.Index.prototype.search = function (e) { return this.query(function (n) { var r = new t.QueryParser(e, n); r.parse(); }); }, t.Index.prototype.query = function (e) { for (var n = new t.Query(this.fields), r = Object.create(null), i = Object.create(null), s = Object.create(null), o = Object.create(null), a = Object.create(null), l = 0; l < this.fields.length; l++)
                ...
                var u = n.clauses[l], d = null, m = t.Set.empty;
                ...
                for (var p = 0; p < d.length; p++) {
                    ...
                    for (var S = 0; S < L.length; S++)
                        for (var w = L[S], k = this.invertedIndex[w], _ = k._index, f = 0; f < u.fields.length; f++) {
                            var y = u.fields[f], B = k[y], A = Object.keys(B), j = w + "/" + y, q = new t.Set(A);
                            if (u.presence == t.Query.presence.REQUIRED && (m = m.union(q), o[y] === void 0 && (o[y] = t.Set.complete)), u.presence == t.Query.presence.PROHIBITED) {
                                a[y] === void 0 && (a[y] = t.Set.empty), a[y] = a[y].union(q);
                                continue;
                            }
                            if (i[y].upsert(_, u.boost, function (Ie, Ce) { return Ie + Ce; }), !s[j]) {
                                for (var V = 0; V < A.length; V++) {
                                    var $ = A[V], C = new t.FieldRef($, y), z = B[$], W;
                                    (W = r[C]) === void 0 ? r[C] = new t.MatchData(w, y, z) : W.add(w, y, z);
                                }
                                s[j] = !0;
                            }
                        }
            ...
            t.Builder = function () { this._ref = "id", this._fields = Object.create(null), this._documents = Object.create(null), this.invertedIndex = Object.create(null), this.fieldTermFrequencies = {}, this.fieldLengths = {}, this.tokenizer = t.tokenizer, this.pipeline = new t.Pipeline, this.searchPipeline = new t.Pipeline, this.documentCount = 0, this._b = .75, this._k1 = 1.2, this.termIndex = 0, this.metadataWhitelist = []; }, t.Builder.prototype.ref = function (e) { this._ref = e; }, t.Builder.prototype.field = function (e, n) { if (/\//.test(e))
                ...
                var o = i[s], a = this._fields[o].extractor, l = a ? a(e) : e[o], u = this.tokenizer(l, { fields: [o] }), d = this.pipeline.run(u), m = new t.FieldRef(r, o), p = Object.create(null);
                ...
                for (var b = 0; b < d.length; b++) {
                    ...
                    for (var y = 0; y < this.metadataWhitelist.length; y++) {
                        var S = this.metadataWhitelist[y], w = g.metadata[S];
                ...
                for (var o = t.FieldRef.fromString(n[s]), a = o.fieldName, l = this.fieldLengths[o], u = new t.Vector, d = this.fieldTermFrequencies[o], m = Object.keys(d), p = m.length, b = this._fields[a].boost || 1, g = this._documents[o.docRef].boost || 1, L = 0; L < p; L++) {
                    var f = m[L], y = d[f], S = this.invertedIndex[f]._index, w, k, _;
                    i[f] === void 0 ? (w = t.idf(this.invertedIndex[f], this.documentCount), i[f] = w) : w = i[f], k = w * ((this._k1 + 1) * y) / (this._k1 * (1 - this._b + this._b * (l / this.averageFieldLength[a])) + y), k *= b, k *= g, _ = Math.round(k * 1e3) / 1e3, u.insert(S, _);
                }
                e[o] = u;
            ...
            } }, function (e, n) { typeof define == "function" && define.amd ? define(n) : typeof ae == "object" ? le.exports = n() : e.lunr = n(); }(this, function () { return t; });
        })();
    });
    var se = [];
    function G(t, e) { se.push({ selector: e, constructor: t }); }
    var U = class {
        ...
        createComponents(e) { se.forEach(n => { e.querySelectorAll(n.selector).forEach(r => { r.dataset.hasInstance || (new n.constructor({ el: r, app: this }), r.dataset.hasInstance = String(!0)); }); }); }
        ...
        ensureActivePageVisible() { let e = document.querySelector(".tsd-navigation .current"), n = e?.parentElement; for (; n && !n.classList.contains(".tsd-navigation");)
            n instanceof HTMLDetailsElement && (n.open = !0), n = n.parentElement; if (e && !Ve(e)) {
    ...
    function Ve(t) { let e = t.getBoundingClientRect(), n = Math.max(document.documentElement.clientHeight, window.innerHeight); return !(e.bottom < 0 || e.top - n >= 0); }
    var oe = (t, e = 100) => { let n; return () => { clearTimeout(n), n = setTimeout(() => t(), e); }; };
    var pe = Ae(ue());
    async function ce(t, e) { if (!window.searchData)
        return; let n = await fetch(window.searchData), r = new Blob([await n.arrayBuffer()]).stream().pipeThrough(new DecompressionStream("gzip")), i = await new Response(r).json(); t.data = i, t.index = pe.Index.load(i.index), e.classList.remove("loading"), e.classList.add("ready"); }
    function fe() { let t = document.getElementById("tsd-search"); if (!t)
        return; let e = { base: t.dataset.base + "/" }, n = document.getElementById("tsd-search-script"); t.classList.add("loading"), n && (n.addEventListener("error", () => { t.classList.remove("loading"), t.classList.add("failure"); }), n.addEventListener("load", () => { ce(e, t); }), ce(e, t)); let r = document.querySelector("#tsd-search input"), i = document.querySelector("#tsd-search .results"); if (!r || !i)
        throw new Error("The input field or the result list wrapper was not found"); i.addEventListener("mouseup", () => { te(t); }), r.addEventListener("focus", () => t.classList.add("has-focus")), He(t, i, r, e); }
    function He(t, e, n, r) { n.addEventListener("input", oe(() => { Ne(t, e, n, r); }, 200)), n.addEventListener("keydown", i => { i.key == "Enter" ? Be(e, t) : i.key == "ArrowUp" ? (de(e, n, -1), i.preventDefault()) : i.key === "ArrowDown" && (de(e, n, 1), i.preventDefault()); }), document.body.addEventListener("keypress", i => { i.altKey || i.ctrlKey || i.metaKey || !n.matches(":focus") && i.key === "/" && (i.preventDefault(), n.focus()); }), document.body.addEventListener("keyup", i => { t.classList.contains("has-focus") && (i.key === "Escape" || !e.matches(":focus-within") && !n.matches(":focus")) && (n.blur(), te(t)); }); }
    function te(t) { t.classList.remove("has-focus"); }
    function Ne(t, e, n, r) {
        if (!r.index || !r.data)
            return;
        e.textContent = "";
        ...
        for (let o = 0, a = Math.min(10, s.length); o < a; o++) {
            let l = r.data.rows[Number(s[o].ref)], u = `<svg width="20" height="20" viewBox="0 0 24 24" fill="none" class="tsd-kind-icon"><use href="#icon-${l.kind}"></use></svg>`, d = he(l.name, i);
            ...
            p.href = r.base + l.url, p.innerHTML = u + d, m.append(p), p.addEventListener("focus", () => { e.querySelector(".current")?.classList.remove("current"), m.classList.add("current"); }), e.appendChild(m);
        }
    }
    function de(t, e, n) { let r = t.querySelector(".current"); if (!r)
        r = t.querySelector(n == 1 ? "li:first-child" : "li:last-child"), r && r.classList.add("current");
    else {
        let i = r;
        if (n === 1)
            do
                i = i.nextElementSibling ?? void 0;
            while (i instanceof HTMLElement && i.offsetParent == null);
        else
            do
                i = i.previousElementSibling ?? void 0;
            while (i instanceof HTMLElement && i.offsetParent == null);
        i ? (r.classList.remove("current"), i.classList.add("current")) : n === -1 && (r.classList.remove("current"), e.focus());
    } }
    function Be(t, e) { let n = t.querySelector(".current"); if (n || (n = t.querySelector("li:first-child")), n) {
    ...
    function he(t, e) { if (e === "")
        ...
        i.push(ee(t.substring(s, o)), `<b>${ee(t.substring(o, o + r.length))}</b>`), s = o + r.length, o = n.indexOf(r, s); return i.push(ee(t.substring(s))), i.join(""); }
    var je = { "&": "&amp;", "<": "&lt;", ">": "&gt;", "'": "&#039;", '"': "&quot;" };
    function ee(t) { return t.replace(/[&<>"'"]/g, e => je[e]); }
    var I = class {
        constructor(e) { this.el = e.el, this.app = e.app; }
    };
    var F = "mousedown", ye = "mousemove", N = "mouseup", J = { x: 0, y: 0 }, me = !1, ne = !1, qe = !1, D = !1, ve = /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent);
    document.documentElement.classList.add(ve ? "is-mobile" : "not-mobile");
    ve && "ontouchstart" in document.documentElement && (qe = !0, F = "touchstart", ye = "touchmove", N = "touchend");
    document.addEventListener(F, t => { ne = !0, D = !1; let e = F == "touchstart" ? t.targetTouches[0] : t; J.y = e.pageY || 0, J.x = e.pageX || 0; });
    document.addEventListener(ye, t => { if (ne && !D) {
        let e = F == "touchstart" ? t.targetTouches[0] : t, n = J.x - (e.pageX || 0), r = J.y - (e.pageY || 0);
        D = Math.sqrt(n * n + r * r) > 10;
    } });
    document.addEventListener(N, () => { ne = !1; });
    document.addEventListener("click", t => { me && (t.preventDefault(), t.stopImmediatePropagation(), me = !1); });
    var X = class extends I {
        constructor(e) { super(e), this.className = this.el.dataset.toggle || "", this.el.addEventListener(N, n => this.onPointerUp(n)), this.el.addEventListener("click", n => n.preventDefault()), document.addEventListener(F, n => this.onDocumentPointerDown(n)), document.addEventListener(N, n => this.onDocumentPointerUp(n)); }
    ...
    try {
        ...
        re = { getItem() { return null; }, setItem() { } };
    }
    var Q = re;
    ...
    var Y = class extends I {
        constructor(e) {
            super(e), this.key = `filter-${this.el.name}`, this.value = this.el.checked, this.el.addEventListener("change", () => { this.setLocalStorage(this.el.checked); }), this.setLocalStorage(this.fromLocalStorage()), ge.innerHTML += `html:not(.${this.key}) .tsd-is-${this.el.name} { display: none; }
`, this.app.updateIndexVisibility();
    ...
    function Ee(t) { let e = Q.getItem("tsd-theme") || "os"; t.value = e, xe(e), t.addEventListener("change", () => { Q.setItem("tsd-theme", t.value), xe(t.value); }); }
    function xe(t) { document.documentElement.dataset.theme = t; }
    var K;
    function we() { let t = document.getElementById("tsd-nav-script"); t && (t.addEventListener("load", Le), Le()); }
    async function Le() { let t = document.getElementById("tsd-nav-container"); if (!t || !window.navigationData)
        return; let n = await (await fetch(window.navigationData)).arrayBuffer(), r = new Blob([n]).stream().pipeThrough(new DecompressionStream("gzip")), i = await new Response(r).json(); K = t.dataset.base, K.endsWith("/") || (K += "/"), t.innerHTML = ""; for (let s of i)
        Se(s, t, []); window.app.createComponents(t), window.app.showPage(), window.app.ensureActivePageVisible(); }
    function Se(t, e, n) { let r = e.appendChild(document.createElement("li")); if (t.children) {
        ...
        o.className = "tsd-accordion-summary", o.dataset.key = i.join("$"), o.innerHTML = '<svg width="20" height="20" viewBox="0 0 24 24" fill="none"><use href="#icon-chevronDown"></use></svg>', be(t, o);
        ...
        be(t, r, t.class); }
    function be(t, e, n) { if (t.path) {
        let r = e.appendChild(document.createElement("a"));
        r.href = K + t.path, n && (r.className = n), location.pathname === r.pathname && !r.href.includes("#") && r.classList.add("current"), t.kind && (r.innerHTML = `<svg width="20" height="20" viewBox="0 0 24 24" fill="none" class="tsd-kind-icon"><use href="#icon-${t.kind}"></use></svg>`), r.appendChild(document.createElement("span")).textContent = t.text;
    }
    else {
        let r = e.appendChild(document.createElement("span"));
        r.innerHTML = '<svg width="20" height="20" viewBox="0 0 24 24" fill="none" class="tsd-kind-icon"><use href="#icon-folder"></use></svg>', r.appendChild(document.createElement("span")).textContent = t.text;
    } }
    G(X, "a[data-toggle]");
    G(Z, ".tsd-accordion");
